...
answerOption.innerHTML = `<select class="select-container" id="answer-select">
                             ...
                             <option value="a">${questionsArr[0].answer.a}</option>
                             <option value="b">${questionsArr[0].answer.b}</option>
                             <option value="c">${questionsArr[0].answer.c}</option>
                             <option value="d">${questionsArr[0].answer.d}</option>
                         </select>`
...
function updateQuestion() {
    if (index < questionsArr.length - 1) {
        ...
        answerOption.innerHTML = `<select id="answer-select" class="select-container">
                                    <option value="--Select Answer--">--Select Answer--</option>
                                    <option value="a">${questionsArr[index].answer.a}</option>
                                    <option value="b">${questionsArr[index].answer.b}</option>
                                    <option value="c">${questionsArr[index].answer.c}</option>
                                    <option value="d">${questionsArr[index].answer.d}</option>
                                </select>`;
    } else {
...
function checkAnswer() {
    ...
    console.log(questionsArr[index].correctAnswer);
